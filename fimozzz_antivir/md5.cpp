...
void md5::md5Step(uint32_t *buffer, uint32_t *input) {
...
void md5::md5Update(MD5Context *ctx, uint8_t *input_buffer, size_t input_len) {
    uint32_t input[16];
...
void md5::md5Finalize(MD5Context *ctx) {
    uint32_t input[16];
    unsigned int offset = ctx->size % 64;
